...
export default function Resume() {
    ...
    return (
        <>
            ...
            <section className="relative grid grid-cols-12 bg-white h-screen w-screen auto-rows-auto grid-flow-row -mt-60 justify-center md:grid-rows-1 md:grid-flow-col">
                <div className="col-start-4 col-span-6 text-3xl font-roboto-600 font-bold text-black w-full uppercase text-start tracking-widest">ABOUT ME
                    {/*<div className="flex flex-column">Another test</div>*/}
                </div>
            </section>
            </>
    )
